...
class AgentOrchestrator:
    ...
    def _openai_tools(self) -> list[dict[str, Any]]:
        return [
            ...
            self._tool_schema("rag_search", {"query": "string", "top_k": "integer", "paper_id": "integer", "ordinal": "integer"}),
            self._tool_schema("rag_answer", {"query": "string", "top_k": "integer", "paper_id": "integer", "ordinal": "integer"}),
